create FUNCTION FoodDelivery_FinalProject.getRestaurantOrderRestaurantPage (@RestaurantID int) returns Table
AS
	...
	from 
	(Select t1.mealName,t1.RestaurantID,t1.MainIngredient,t1.SideIngredient,t1.Drink,MealCost,RequestID
	From
