CREATE Function FoodDelivery_FinalProject.getRestaurantMeal(@RequestID int)returns Table
AS 
	Return(SELECT FoodDelivery_FinalProject.Meal.Name, MealCost,MainIngredient,SideIngredient,Drink
