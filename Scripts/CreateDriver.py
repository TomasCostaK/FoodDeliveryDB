...
insert_people = open('insert_driver.txt', 'w', encoding='utf8')
driver_id_used=open('driver_id.txt', 'w', encoding='utf8')

f = open('last_names.txt', 'r')
T = open('license_plates.txt', 'r')
last_names = []
license_plates_used=[]
for line in f:
...
for line in T:
    license_plates_used.append(line.strip('\n'))
